...
#ifndef BACKENDS_MUTEX_WIN32_H
#define BACKENDS_MUTEX_WIN32_H
 ...
 * Win32 mutex manager
 */
class Win32MutexManager : public MutexManager {
public:
	Win32MutexManager();
    virtual ~Win32MutexManager();
...
protected:
	struct Win32MutexDetail &_detail;
};
